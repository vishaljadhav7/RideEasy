...
const LocationExplorerPanel = () => {
  ...
  return (
    <div className="">
      <div  onClick={() => handleSuggestionClick("elem wefwsrg")} className='flex gap-4 border-2 p-3 border-gray-50 active:border-black rounded-xl items-center my-2 justify-start'>
