        ...
        <div className='bg-white '>
            ...
            <div className='flex items-center justify-between p-3 bg-yellow-400 rounded-lg mt-4'>
                <div className='flex items-center gap-3 '>
                    ...
                    <h2 className='text-lg font-medium'>Dedfs afsaedf</h2>
                </div>
                ...
                <div className='w-full mt-5'>
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        ...
                        <div>
                            ...
                            <p className='text-sm -mt-1 text-gray-600'>adas awcad adasda </p>
                        </div>
                    </div>
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        ...
                        <div>
                            <h3 className='text-lg font-medium'>562/11-A</h3>
                            <p className='text-sm -mt-1 text-gray-600'>ascs ascad awdw</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-5 p-3'>
                        <i className="ri-currency-line"></i>
                        <div>
                            <h3 className='text-lg font-medium'>₹232/-</h3>
